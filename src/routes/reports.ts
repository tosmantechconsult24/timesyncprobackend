...
router.get('/attendance', requirePermission('reports:read'), asyncHandler(async (req: AuthRequest, res: Response) => {
...
// Get overtime report
router.get('/overtime', requirePermission('reports:read'), asyncHandler(async (req: AuthRequest, res: Response) => {
...
router.get('/lateness', requirePermission('reports:read'), asyncHandler(async (req: AuthRequest, res: Response) => {
...
router.get('/payroll', requirePermission('reports:read'), asyncHandler(async (req: AuthRequest, res: Response) => {
  const { startDate, endDate, departmentId } = req.query;
...
// Export report data
router.get('/export/:type', requirePermission('reports:export'), asyncHandler(async (req: AuthRequest, res: Response) => {
...
router.get('/dashboard', requirePermission('reports:read'), asyncHandler(async (req: AuthRequest, res: Response) => {
...
router.get('/attendance-summary', requirePermission('reports:read'), asyncHandler(async (req: AuthRequest, res: Response) => {
  const { startDate, endDate, departmentId, employeeId, groupBy = 'day' } = req.query;
  ...
  const allEmployees = await prisma.employee.findMany({
    where: { status: 'active', ...(departmentId && { departmentId: departmentId as string }), ...(employeeId && { id: employeeId as string }) },
    include: { shift: true, department: true }
  });
...
router.get('/employee/:employeeId', requirePermission('reports:read'), asyncHandler(async (req: AuthRequest, res: Response) => {
...
router.get('/department/:departmentId', requirePermission('reports:read'), asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  const where: any = { Employee: { departmentId } };
...
router.get('/monthly', requirePermission('reports:read'), asyncHandler(async (req: AuthRequest, res: Response) => {
